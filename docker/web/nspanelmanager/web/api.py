        ...
        try:
            ...
            if home_assistant_response.status_code == 200:
                for entity in home_assistant_response.json():
                    if (entity["entity_id"].startswith("light.") or entity["entity_id"].startswith("switch.") or entity["entity_id"].startswith("input_boolean.") or entity["entity_id"].startswith("fan.")):
